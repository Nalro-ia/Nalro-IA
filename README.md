# 👋 Bonjour ! Je suis Orlan (Nalro.IA)

Technicien de déploiement IT spécialisé en infrastructure et réseaux. Passionné par l'automatisation, j'explore et construis des systèmes intelligents pour simplifier les processus complexes.

> "Je ne construis pas juste des scripts, je conçois des services fiables et maintenables, en alliant la rigueur du Datacenter à la puissance de l'IA générative."

---

### 🚀 Ce que je fais

Je construis mes projets pour mieux comprendre comment intégrer l'IA au quotidien. Ma démarche est simple : **apprendre en faisant**, expérimenter avec les LLM et automatiser des tâches pour transformer des concepts abstraits en outils fonctionnels. 

**Nalro.IA** est mon laboratoire personnel pour explorer ces technologies et partager mes avancées.
...
*   **Infrastructure, Sécurité & Datacenter (10 ans) :**
    *   Production Serveurs (5 ans) : Expertise couvrant l'intégralité du cycle de vie matériel : de la conception et l'assemblage en chaîne de production industrielle, jusqu'à l'installation et la mise en service des systèmes. Une immersion totale dans le hardware qui m'a permis de maîtriser l'architecture et le fonctionnement intime des serveurs.
...
*   **Automatisation & IA (Learning Journey) :**
    *   En phase d'exploration active, j'applique la rigueur apprise en Datacenter à l'IA.
    *   Conception de pipelines "end-to-end" où la stabilité et la sécurité sont prioritaires. Mon approche **"Privacy-first"** est directement héritée de mes années en environnement sécurisé.

*   **Architecture & Orchestration :**
    *   Expertise dans l'interconnexion de services et l'automatisation de workflows complexes.
    *   Capacité à orchestrer des flux de données avec une approche systémique.
...
*Mes projets sont en phase de développement actif. Vous souhaitez discuter d'automatisation, d'infrastructure ou de projets IA ? N'hésitez pas à me contacter !*
